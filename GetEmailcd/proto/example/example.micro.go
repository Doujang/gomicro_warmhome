...
/*
Package go_micro_srv_GetEmailcd is a generated protocol buffer package.
...
type ExampleService interface {
	GetEmailCd(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func (c *exampleService) GetEmailCd(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.GetEmailCd", in)
	out := new(Response)
...
type ExampleHandler interface {
	GetEmailCd(context.Context, *Request, *Response) error
...
func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		GetEmailCd(ctx context.Context, in *Request, out *Response) error
...
func (h *exampleHandler) GetEmailCd(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.GetEmailCd(ctx, in, out)
}
